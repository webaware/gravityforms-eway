...
class GfEwayRequires {
	...
	protected function init() {
		if (!is_array($this->notices)) {
			...
			add_action('after_plugin_row_' . GFEWAY_PLUGIN_NAME, array($this, 'showPluginRowNotices'), 9, 2);
		}
	}
	...
	public function maybeShowAdminNotices() {
		if ($this->canShowAdminNotices()) {
			...
			require GFEWAY_PLUGIN_ROOT . 'views/requires-admin-notice.php';
		}
	}
	...
	public function showPluginRowNotices() {
		...
		$notices = $this->notices;
		require GFEWAY_PLUGIN_ROOT . 'views/requires-plugin-notice.php';
	}
