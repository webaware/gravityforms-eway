...
<div class="error gfeway-dismissable" data-gfeway-dismiss="upgrade_from_v1">
	<p><?php _e('Gravity Forms eWAY has been upgraded. Please ensure check your settings.', 'gravityforms-eway'); ?></p>

	<ul style="padding-left: 2em">
		<?php if (empty($options['apiKey']) && empty($options['apiPassword'])):  ?>
		<li style="list-style-type:disc"><?php printf(__('please enter your eWAY API key and password in <a href="%s">eWAY Payments settings</a> to upgrade to Rapid API', 'gravityforms-eway'), esc_url($ewaySettingsURL)); ?></li>
		<?php endif; ?>
